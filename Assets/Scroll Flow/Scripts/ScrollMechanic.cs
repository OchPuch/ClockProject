...
namespace Scroll_Flow.Scripts
{
        ...
        IPointerEnterHandler
    {
        ...
        private bool _preventNextValueUpdate;
        ...
        public void SetCurrentValue(int firstTarget)
        {
            _preventNextValueUpdate = true;
        ...
        private void CheckValue()
        {
            ...
            if (_preventNextValueUpdate)
            {
                _lastValue = currentValue;
                _preventNextValueUpdate = false;
                return;
            }
